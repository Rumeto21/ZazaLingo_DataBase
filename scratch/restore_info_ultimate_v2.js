...
const HEX_MAP = [
    ...
    { hex: 'c383c284c382c29f', replace: 'ğ' }, // Triple ğ variant 1
    { hex: 'c383c284c29f', replace: 'ğ' },     // Triple ğ variant 2
    { hex: 'c384c29f', replace: 'ğ' },         // Double ğ
    { hex: 'c383c283c382c287', replace: 'Ç' }, // Triple Ç
    { hex: 'c383c282c2bc', replace: 'ü' },
    { hex: 'c383c282c2b6', replace: 'ö' }
];

console.log('🚀 Restoring Info with ULTIMATE HEX PATTERNS...');
