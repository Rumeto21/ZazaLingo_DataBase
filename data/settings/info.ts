    ...
    "dedications": [
        {
            "from": "Onur Şenoğlu",
            "to": {
                "Tr": "Bu uygulamadaki çalışmalarımı başta Dedem İsa Yıldız olmak üzere Bekan ve Saroyan ailelerine ve Değerli arkadaşım Şevîn Roşna Hocaoğlu'na ithaf ediyorum."
            }
        }
    ],
    "music": [
        {
            "title": {
                "Tr": "Piano Sonata No. 10 in C Major, K.330"
            },
