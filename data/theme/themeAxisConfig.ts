...
export const THEME_AXIS_MAP: Record<string, ThemeAxis> = {
    ...
    settingsContentBoxWidth:            'W',
    settingsContentBoxHeight:           'V',
    settingsContentBoxMarginLeft:       'X',
    settingsContentBoxMarginTop:        'Y',
    settings_music_toggleWidth:         'W',
    settings_music_toggleHeight:        'V',
    settings_music_toggleMarginTop:     'Y',
    settings_music_toggleMarginLeft:    'X',
    settings_music_slider_generalWidth: 'W',
    settings_music_slider_generalHeight:'V',
    settings_music_slider_generalMarginTop: 'Y',
    settings_music_slider_generalMarginLeft: 'X',
    settings_music_slider_testWidth:    'W',
    settings_music_slider_testHeight:   'V',
    settings_music_slider_testMarginTop:'Y',
    settings_music_slider_testMarginLeft:'X',
